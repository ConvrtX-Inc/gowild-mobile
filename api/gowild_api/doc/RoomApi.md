...
------------- | ------------- | -------------
[**createOneBaseRoomControllerRoom**](RoomApi.md#createonebaseroomcontrollerroom) | **POST** /api/v1/room | Create one Room
[**deleteOneBaseRoomControllerRoom**](RoomApi.md#deleteonebaseroomcontrollerroom) | **DELETE** /api/v1/room/{id} | Delete one Room
[**getManyBaseRoomControllerRoom**](RoomApi.md#getmanybaseroomcontrollerroom) | **GET** /api/v1/room | Retrieve many Room
[**getOneBaseRoomControllerRoom**](RoomApi.md#getonebaseroomcontrollerroom) | **GET** /api/v1/room/{id} | Retrieve one Room
[**updateOneBaseRoomControllerRoom**](RoomApi.md#updateonebaseroomcontrollerroom) | **PATCH** /api/v1/room/{id} | Update one Room


# **createOneBaseRoomControllerRoom**
> Room createOneBaseRoomControllerRoom(room)
...
final api = GowildApi().getRoomApi();
final Room room = ; // Room | 

try {
    final response = api.createOneBaseRoomControllerRoom(room);
    print(response);
} catch on DioError (e) {
    print('Exception when calling RoomApi->createOneBaseRoomControllerRoom: $e\n');
}
```
...
# **deleteOneBaseRoomControllerRoom**
> deleteOneBaseRoomControllerRoom(id)
...
try {
    api.deleteOneBaseRoomControllerRoom(id);
} catch on DioError (e) {
    print('Exception when calling RoomApi->deleteOneBaseRoomControllerRoom: $e\n');
}
```
...
try {
    final response = api.getManyBaseRoomControllerRoom(fields, s, filter, or, sort, join, limit, offset, page, cache);
    print(response);
} catch on DioError (e) {
    print('Exception when calling RoomApi->getManyBaseRoomControllerRoom: $e\n');
}
```
...
# **getOneBaseRoomControllerRoom**
> Room getOneBaseRoomControllerRoom(id, fields, join, cache)
...
try {
    final response = api.getOneBaseRoomControllerRoom(id, fields, join, cache);
    print(response);
} catch on DioError (e) {
    print('Exception when calling RoomApi->getOneBaseRoomControllerRoom: $e\n');
}
```
...
# **updateOneBaseRoomControllerRoom**
> Room updateOneBaseRoomControllerRoom(id, room)
...
try {
    final response = api.updateOneBaseRoomControllerRoom(id, room);
    print(response);
} catch on DioError (e) {
    print('Exception when calling RoomApi->updateOneBaseRoomControllerRoom: $e\n');
}
```

...
------------- | ------------- | -------------
[**getManyBaseCurrencyControllerCurrency**](CurrenciesApi.md#getmanybasecurrencycontrollercurrency) | **GET** /api/v1/currencies | Retrieve many Currency
[**getOneBaseCurrencyControllerCurrency**](CurrenciesApi.md#getonebasecurrencycontrollercurrency) | **GET** /api/v1/currencies/{id} | Retrieve one Currency
...
final api = GowildApi().getCurrenciesApi();
...
try {
    final response = api.getManyBaseCurrencyControllerCurrency(fields, s, filter, or, sort, join, limit, offset, page, cache);
    print(response);
} catch on DioError (e) {
    print('Exception when calling CurrenciesApi->getManyBaseCurrencyControllerCurrency: $e\n');
}
```
...
# **getOneBaseCurrencyControllerCurrency**
> Currency getOneBaseCurrencyControllerCurrency(id, fields, join, cache)
...
try {
    final response = api.getOneBaseCurrencyControllerCurrency(id, fields, join, cache);
    print(response);
} catch on DioError (e) {
    print('Exception when calling CurrenciesApi->getOneBaseCurrencyControllerCurrency: $e\n');
}
```

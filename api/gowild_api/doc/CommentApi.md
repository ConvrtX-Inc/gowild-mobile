...
------------- | ------------- | -------------
[**createOneBaseCommentControllerComment**](CommentApi.md#createonebasecommentcontrollercomment) | **POST** /api/v1/comment | Create one Comment
[**deleteOneBaseCommentControllerComment**](CommentApi.md#deleteonebasecommentcontrollercomment) | **DELETE** /api/v1/comment/{id} | Delete one Comment
[**getManyBaseCommentControllerComment**](CommentApi.md#getmanybasecommentcontrollercomment) | **GET** /api/v1/comment | Retrieve many Comment
[**getOneBaseCommentControllerComment**](CommentApi.md#getonebasecommentcontrollercomment) | **GET** /api/v1/comment/{id} | Retrieve one Comment
[**updateOneBaseCommentControllerComment**](CommentApi.md#updateonebasecommentcontrollercomment) | **PATCH** /api/v1/comment/{id} | Update one Comment


# **createOneBaseCommentControllerComment**
> Comment createOneBaseCommentControllerComment(comment)
...
final api = GowildApi().getCommentApi();
final Comment comment = ; // Comment | 

try {
    final response = api.createOneBaseCommentControllerComment(comment);
    print(response);
} catch on DioError (e) {
    print('Exception when calling CommentApi->createOneBaseCommentControllerComment: $e\n');
}
```
...
# **deleteOneBaseCommentControllerComment**
> deleteOneBaseCommentControllerComment(id)
...
try {
    api.deleteOneBaseCommentControllerComment(id);
} catch on DioError (e) {
    print('Exception when calling CommentApi->deleteOneBaseCommentControllerComment: $e\n');
}
```
...
# **getManyBaseCommentControllerComment**
> GetManyCommentResponseDto getManyBaseCommentControllerComment(fields, s, filter, or, sort, join, limit, offset, page, cache)
...
try {
    final response = api.getManyBaseCommentControllerComment(fields, s, filter, or, sort, join, limit, offset, page, cache);
    print(response);
} catch on DioError (e) {
    print('Exception when calling CommentApi->getManyBaseCommentControllerComment: $e\n');
}
```
...
[**GetManyCommentResponseDto**](GetManyCommentResponseDto.md)
...
# **getOneBaseCommentControllerComment**
> Comment getOneBaseCommentControllerComment(id, fields, join, cache)
...
try {
    final response = api.getOneBaseCommentControllerComment(id, fields, join, cache);
    print(response);
} catch on DioError (e) {
    print('Exception when calling CommentApi->getOneBaseCommentControllerComment: $e\n');
}
```
...
# **updateOneBaseCommentControllerComment**
> Comment updateOneBaseCommentControllerComment(id, comment)
...
try {
    final response = api.updateOneBaseCommentControllerComment(id, comment);
    print(response);
} catch on DioError (e) {
    print('Exception when calling CommentApi->updateOneBaseCommentControllerComment: $e\n');
}
```

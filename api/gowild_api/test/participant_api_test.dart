...
void main() {
  ...
  group(ParticipantApi, () {
    ...
    //
    //Future<GetManyParticipantResponseDto> getManyBaseParticipantControllerParticipant({ BuiltList<String> fields, String s, BuiltList<String> filter, BuiltList<String> or, BuiltList<String> sort, BuiltList<String> join, int limit, int offset, int page, int cache }) async

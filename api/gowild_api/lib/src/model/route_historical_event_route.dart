...
part 'route_historical_event_route.g.dart';
...
/// * [picture] 
/// * [description] 
abstract class RouteHistoricalEventRoute implements Built<RouteHistoricalEventRoute, RouteHistoricalEventRouteBuilder> {
    ...
    RouteHistoricalEventRoute._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(RouteHistoricalEventRouteBuilder b) => b;

    factory RouteHistoricalEventRoute([void updates(RouteHistoricalEventRouteBuilder b)]) = _$RouteHistoricalEventRoute;

    @BuiltValueSerializer(custom: true)
    static Serializer<RouteHistoricalEventRoute> get serializer => _$RouteHistoricalEventRouteSerializer();
}

class _$RouteHistoricalEventRouteSerializer implements StructuredSerializer<RouteHistoricalEventRoute> {
    @override
    final Iterable<Type> types = const [RouteHistoricalEventRoute, _$RouteHistoricalEventRoute];

    @override
    final String wireName = r'RouteHistoricalEventRoute';

    @override
    Iterable<Object?> serialize(Serializers serializers, RouteHistoricalEventRoute object,
    ...
    @override
    RouteHistoricalEventRoute deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = RouteHistoricalEventRouteBuilder();

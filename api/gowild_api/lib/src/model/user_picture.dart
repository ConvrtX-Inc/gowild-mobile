...
/// * [fileName] 
/// * [metaData] 
abstract class UserPicture implements Built<UserPicture, UserPictureBuilder> {
    ...
    static void _defaults(UserPictureBuilder b) => b;

    factory UserPicture([void updates(UserPictureBuilder b)]) = _$UserPicture;

    @BuiltValueSerializer(custom: true)
    static Serializer<UserPicture> get serializer => _$UserPictureSerializer();
}

class _$UserPictureSerializer implements StructuredSerializer<UserPicture> {
    @override
    final Iterable<Type> types = const [UserPicture, _$UserPicture];

    @override
    final String wireName = r'UserPicture';

    @override
    Iterable<Object?> serialize(Serializers serializers, UserPicture object,
    ...
    @override
    UserPicture deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = UserPictureBuilder();

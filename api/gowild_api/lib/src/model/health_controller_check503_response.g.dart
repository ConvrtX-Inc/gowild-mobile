...
class _$HealthControllerCheck503Response
  ...
  factory _$HealthControllerCheck503Response(
      ...
      (new HealthControllerCheck503ResponseBuilder()..update(updates))._build();
  ...
  HealthControllerCheck503ResponseBuilder toBuilder() =>
      new HealthControllerCheck503ResponseBuilder()..replace(this);
...
class HealthControllerCheck503ResponseBuilder
    implements
        Builder<HealthControllerCheck503Response,
  ...
  _$HealthControllerCheck503Response _build() {
    ...
    try {
      _$result = _$v ??
          new _$HealthControllerCheck503Response._(
              status: status,
              info: _info?.build(),
              error: _error?.build(),
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'HealthControllerCheck503Response', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);

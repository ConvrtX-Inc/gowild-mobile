...
class SponsorApi {
  ...
  Future<Response<Sponsor>> createOneBaseSponsorControllerSponsor({ 
    ...
    try {
      const _type = FullType(Sponsor);
      _bodyData = _serializers.serialize(sponsor, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> deleteOneBaseSponsorControllerSponsor({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/sponsor/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetManySponsorResponseDto] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GetManySponsorResponseDto>> getManyBaseSponsorControllerSponsor({ 
    ...
    GetManySponsorResponseDto _responseData;

    try {
      const _responseType = FullType(GetManySponsorResponseDto);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as GetManySponsorResponseDto;
    ...
    return Response<GetManySponsorResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [Sponsor] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Sponsor>> getOneBaseSponsorControllerSponsor({ 
    required String id,
    BuiltList<String>? fields,
    BuiltList<String>? join,
    int? cache,
  ...
  /// Returns a [Future] containing a [Response] with a [Sponsor] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Sponsor>> updateOneBaseSponsorControllerSponsor({ 
    required String id,
    required Sponsor sponsor,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,

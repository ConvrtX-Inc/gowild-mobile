...
class RoomApi {
  ...
  const RoomApi(this._dio, this._serializers);
  ...
  Future<Response<Room>> createOneBaseRoomControllerRoom({ 
    required Room room,
    ...
    try {
      const _type = FullType(Room);
      _bodyData = _serializers.serialize(room, specifiedType: _type);
    ...
    try {
      const _responseType = FullType(Room);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> deleteOneBaseRoomControllerRoom({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/room/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Room] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Room>> getOneBaseRoomControllerRoom({ 
    required String id,
    BuiltList<String>? fields,
    BuiltList<String>? join,
    int? cache,
  ...
  /// Returns a [Future] containing a [Response] with a [Room] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Room>> updateOneBaseRoomControllerRoom({ 
    required String id,
    required Room room,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,

...
class RouteHistoricalEventApi {

  final Dio _dio;

  final Serializers _serializers;

  const RouteHistoricalEventApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [RouteHistoricalEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RouteHistoricalEvent>> createOneBaseRouteHistoricalEventsControllerRouteHistoricalEvent({ 
    required RouteHistoricalEvent routeHistoricalEvent,
    ...
    final _path = r'/api/v1/route-historical-events';
    ...
    try {
      const _type = FullType(RouteHistoricalEvent);
      _bodyData = _serializers.serialize(routeHistoricalEvent, specifiedType: _type);
    ...
    RouteHistoricalEvent _responseData;

    try {
      const _responseType = FullType(RouteHistoricalEvent);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as RouteHistoricalEvent;
    ...
    return Response<RouteHistoricalEvent>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> deleteOneBaseRouteHistoricalEventsControllerRouteHistoricalEvent({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/route-historical-events/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetManyRouteHistoricalEventResponseDto] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GetManyRouteHistoricalEventResponseDto>> getManyBaseRouteHistoricalEventsControllerRouteHistoricalEvent({ 
    ...
    GetManyRouteHistoricalEventResponseDto _responseData;

    try {
      const _responseType = FullType(GetManyRouteHistoricalEventResponseDto);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as GetManyRouteHistoricalEventResponseDto;
    ...
    return Response<GetManyRouteHistoricalEventResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [RouteHistoricalEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RouteHistoricalEvent>> getOneBaseRouteHistoricalEventsControllerRouteHistoricalEvent({ 
    required String id,
    BuiltList<String>? fields,
    BuiltList<String>? join,
    int? cache,
  ...
  /// Returns a [Future] containing a [Response] with a [RouteHistoricalEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RouteHistoricalEvent>> routeHistoricalEventsControllerUpdateMedias({ 
    required String id,
    required BuiltList<ImageUpdateDto> imageUpdateDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/route-historical-events/{id}/medias'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(BuiltList, [FullType(ImageUpdateDto)]);
  ...
  /// Returns a [Future] containing a [Response] with a [RouteHistoricalEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RouteHistoricalEvent>> routeHistoricalEventsControllerUpdatePicture({ 
    required String id,
    ...
    final _path = r'/api/v1/route-historical-events/{id}/update-picture'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [RouteHistoricalEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RouteHistoricalEvent>> updateOneBaseRouteHistoricalEventsControllerRouteHistoricalEvent({ 
    required String id,
    required RouteHistoricalEvent routeHistoricalEvent,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,

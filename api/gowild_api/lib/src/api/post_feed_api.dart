...
class PostFeedApi {
  ...
  const PostFeedApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [PostFeed] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<PostFeed>> createOneBasePostFeedControllerPostFeed({ 
    required PostFeed postFeed,
    ...
    final _path = r'/api/v1/post-feed';
    ...
    try {
      const _type = FullType(PostFeed);
      _bodyData = _serializers.serialize(postFeed, specifiedType: _type);
    ...
    PostFeed _responseData;

    try {
      const _responseType = FullType(PostFeed);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> deleteOneBasePostFeedControllerPostFeed({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/post-feed/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [PostFeed] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<PostFeed>> getOneBasePostFeedControllerPostFeed({ 
    required String id,
    BuiltList<String>? fields,
    BuiltList<String>? join,
    int? cache,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> postFeedControllerGetFriendsPost({ 
    ...
    final _path = r'/api/v1/post-feed/friends-post/{user_id}'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> postFeedControllerGetPostsFromOtherUsers({ 
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/post-feed/other-users-posts/{user_id}'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [PostFeed] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<PostFeed>> updateOneBasePostFeedControllerPostFeed({ 
    required String id,
    required PostFeed postFeed,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,

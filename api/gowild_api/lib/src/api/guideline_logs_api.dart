...
import 'package:gowild_api/src/model/get_many_base_guideline_logs_controller_guideline_log200_response.dart';
import 'package:gowild_api/src/model/guideline_log.dart';

class GuidelineLogsApi {

  final Dio _dio;

  final Serializers _serializers;

  const GuidelineLogsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GuidelineLog] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GuidelineLog>> createOneBaseGuidelineLogsControllerGuidelineLog({ 
    required GuidelineLog guidelineLog,
    ...
    final _path = r'/api/v1/guideline-logs';
    ...
    try {
      const _type = FullType(GuidelineLog);
      _bodyData = _serializers.serialize(guidelineLog, specifiedType: _type);
    ...
    GuidelineLog _responseData;

    try {
      const _responseType = FullType(GuidelineLog);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> deleteOneBaseGuidelineLogsControllerGuidelineLog({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/guideline-logs/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetManyBaseGuidelineLogsControllerGuidelineLog200Response] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GetManyBaseGuidelineLogsControllerGuidelineLog200Response>> getManyBaseGuidelineLogsControllerGuidelineLog({ 
    ...
    GetManyBaseGuidelineLogsControllerGuidelineLog200Response _responseData;

    try {
      const _responseType = FullType(GetManyBaseGuidelineLogsControllerGuidelineLog200Response);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as GetManyBaseGuidelineLogsControllerGuidelineLog200Response;
    ...
    return Response<GetManyBaseGuidelineLogsControllerGuidelineLog200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [GuidelineLog] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GuidelineLog>> getOneBaseGuidelineLogsControllerGuidelineLog({ 
    required String id,
    BuiltList<String>? fields,
    BuiltList<String>? join,
    int? cache,
  ...
  /// Returns a [Future] containing a [Response] with a [GuidelineLog] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GuidelineLog>> updateOneBaseGuidelineLogsControllerGuidelineLog({ 
    required String id,
    required GuidelineLog guidelineLog,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,

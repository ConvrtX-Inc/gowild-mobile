...
class StatusApi {
  ...
  Future<Response<Status>> createOneBaseStatusControllerStatus({ 
    ...
    try {
      const _type = FullType(Status);
      _bodyData = _serializers.serialize(status, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> deleteOneBaseStatusControllerStatus({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/statuses/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Status>> getOneBaseStatusControllerStatus({ 
    required String id,
    BuiltList<String>? fields,
    BuiltList<String>? join,
    int? cache,
  ...
  /// Returns a [Future] containing a [Response] with a [Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Status>> updateOneBaseStatusControllerStatus({ 
    required String id,
    required Status status,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,

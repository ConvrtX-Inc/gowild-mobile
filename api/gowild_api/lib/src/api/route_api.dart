...
class RouteApi {
  ...
  const RouteApi(this._dio, this._serializers);
  ...
  Future<Response<Route>> createOneBaseRouteControllerRoute({ 
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> deleteOneBaseRouteControllerRoute({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/route/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Route] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Route>> getOneBaseRouteControllerRoute({ 
    required String id,
    BuiltList<String>? fields,
    BuiltList<String>? join,
    int? cache,
  ...
  /// Returns a [Future] containing a [Response] with a [Route] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Route>> routeControllerUpdatePicture({ 
    required String id,
    ...
    final _path = r'/api/v1/route/{id}/update-picture'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Route] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Route>> updateOneBaseRouteControllerRoute({ 
    required String id,
    required Route route,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,

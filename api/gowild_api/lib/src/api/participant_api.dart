...
class ParticipantApi {
  ...
  const ParticipantApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Participant] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Participant>> createOneBaseParticipantControllerParticipant({ 
    ...
    final _path = r'/api/v1/participants';
    ...
    try {
      const _type = FullType(Participant);
      _bodyData = _serializers.serialize(participant, specifiedType: _type);
    ...
    Participant _responseData;

    try {
      const _responseType = FullType(Participant);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> deleteOneBaseParticipantControllerParticipant({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/participants/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Participant] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Participant>> getOneBaseParticipantControllerParticipant({ 
    required String id,
    BuiltList<String>? fields,
    BuiltList<String>? join,
    int? cache,
  ...
  /// Returns a [Future] containing a [Response] with a [Participant] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Participant>> updateOneBaseParticipantControllerParticipant({ 
    required String id,
    required Participant participant,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,

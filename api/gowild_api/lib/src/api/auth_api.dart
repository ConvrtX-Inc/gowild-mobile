...
import 'package:gowild_api/src/model/login_response.dart';
...
class AuthApi {
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<LoginResponse>> authControllerLogin({ 
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> authFacebookControllerLogin({ 
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> authGoogleControllerLogin({ 

...
class AuthApi {
  ...
  Future<Response<User>> authControllerGenerateAdmin({ 
    ...
    final _path = r'/api/v1/auth/generate-admin';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<TokenResponse>> authControllerLogin({ 
  ...
  /// Returns a [Future] containing a [Response] with a [TokenResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<TokenResponse>> authControllerRefreshToken({ 
    required AuthRefreshTokenDto authRefreshTokenDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/auth/refresh-token';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(AuthRefreshTokenDto);
      _bodyData = _serializers.serialize(authRefreshTokenDto, specifiedType: _type);
  ...
  Future<Response<User>> authControllerResetAdminPassword({ 
    ...
    final _path = r'/api/v1/auth/reset-admin-password';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(AuthResetPasswordAdminDto);
      _bodyData = _serializers.serialize(authResetPasswordAdminDto, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserAuthResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UserAuthResponse>> authFacebookControllerLogin({ 
    required AuthFacebookLoginDto authFacebookLoginDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/auth/facebook/login';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(AuthFacebookLoginDto);
      _bodyData = _serializers.serialize(authFacebookLoginDto, specifiedType: _type);
    ...
    UserAuthResponse _responseData;

    try {
      const _responseType = FullType(UserAuthResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as UserAuthResponse;
  ...
  /// Returns a [Future] containing a [Response] with a [UserAuthResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UserAuthResponse>> authGoogleControllerLogin({ 
    ...
    final _path = r'/api/v1/auth/google/login';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,

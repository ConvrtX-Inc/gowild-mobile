...
class TreasureChestApi {
  ...
  const TreasureChestApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [TreasureChest] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<TreasureChest>> createOneBaseTreasureChestControllerTreasureChest({ 
    required TreasureChest treasureChest,
    ...
    final _path = r'/api/v1/treasure-chest';
    ...
    try {
      const _type = FullType(TreasureChest);
      _bodyData = _serializers.serialize(treasureChest, specifiedType: _type);
    ...
    TreasureChest _responseData;

    try {
      const _responseType = FullType(TreasureChest);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> deleteOneBaseTreasureChestControllerTreasureChest({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/treasure-chest/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetManyTreasureChestResponseDto] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GetManyTreasureChestResponseDto>> getManyBaseTreasureChestControllerTreasureChest({ 
    ...
    GetManyTreasureChestResponseDto _responseData;

    try {
      const _responseType = FullType(GetManyTreasureChestResponseDto);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as GetManyTreasureChestResponseDto;
    ...
    return Response<GetManyTreasureChestResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [TreasureChest] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<TreasureChest>> getOneBaseTreasureChestControllerTreasureChest({ 
    required String id,
    BuiltList<String>? fields,
    BuiltList<String>? join,
    int? cache,
  ...
  /// Returns a [Future] containing a [Response] with a [TreasureChest] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<TreasureChest>> updateOneBaseTreasureChestControllerTreasureChest({ 
    required String id,
    required TreasureChest treasureChest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,

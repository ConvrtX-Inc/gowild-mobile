...
class GuidelinesApi {
  ...
  const GuidelinesApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Guideline] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Guideline>> createOneBaseGuidelinesControllerGuideline({ 
    ...
    final _path = r'/api/v1/guidelines';
    ...
    try {
      const _type = FullType(Guideline);
      _bodyData = _serializers.serialize(guideline, specifiedType: _type);
    ...
    Guideline _responseData;

    try {
      const _responseType = FullType(Guideline);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> deleteOneBaseGuidelinesControllerGuideline({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/guidelines/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Guideline] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Guideline>> getOneBaseGuidelinesControllerGuideline({ 
    required String id,
    BuiltList<String>? fields,
    BuiltList<String>? join,
    int? cache,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> guidelinesControllerGetTermsByType({ 
    ...
    final _path = r'/api/v1/guidelines/{type}'.replaceAll('{' r'type' '}', type.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Guideline] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Guideline>> updateOneBaseGuidelinesControllerGuideline({ 
    required String id,
    required Guideline guideline,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,

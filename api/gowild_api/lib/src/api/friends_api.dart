...
import 'package:gowild_api/src/model/get_many_base_friends_controller_friends200_response.dart';
...
class FriendsApi {
  ...
  Future<Response<Friends>> createOneBaseFriendsControllerFriends({ 
    ...
    try {
      const _type = FullType(Friends);
      _bodyData = _serializers.serialize(friends, specifiedType: _type);
    ...
    try {
      const _responseType = FullType(Friends);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> deleteOneBaseFriendsControllerFriends({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/friends/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> friendsControllerGetSuggestedFriends({ 
    ...
    final _path = r'/api/v1/friends/suggested-friends/{user_id}'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetManyBaseFriendsControllerFriends200Response] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GetManyBaseFriendsControllerFriends200Response>> getManyBaseFriendsControllerFriends({ 
    ...
    GetManyBaseFriendsControllerFriends200Response _responseData;

    try {
      const _responseType = FullType(GetManyBaseFriendsControllerFriends200Response);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as GetManyBaseFriendsControllerFriends200Response;
    ...
    return Response<GetManyBaseFriendsControllerFriends200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [Friends] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Friends>> getOneBaseFriendsControllerFriends({ 
    required String id,
    BuiltList<String>? fields,
    BuiltList<String>? join,
    int? cache,
  ...
  /// Returns a [Future] containing a [Response] with a [Friends] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Friends>> updateOneBaseFriendsControllerFriends({ 
    required String id,
    required Friends friends,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,

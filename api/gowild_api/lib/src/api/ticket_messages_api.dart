...
class TicketMessagesApi {

  final Dio _dio;

  final Serializers _serializers;

  const TicketMessagesApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [TicketMessage] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<TicketMessage>> createOneBaseTicketMessagesControllerTicketMessage({ 
    ...
    final _path = r'/api/v1/ticket-messages';
    ...
    try {
      const _type = FullType(TicketMessage);
      _bodyData = _serializers.serialize(ticketMessage, specifiedType: _type);
    ...
    TicketMessage _responseData;

    try {
      const _responseType = FullType(TicketMessage);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> deleteOneBaseTicketMessagesControllerTicketMessage({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/ticket-messages/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetManyTicketMessageResponseDto] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GetManyTicketMessageResponseDto>> getManyBaseTicketMessagesControllerTicketMessage({ 
    ...
    GetManyTicketMessageResponseDto _responseData;

    try {
      const _responseType = FullType(GetManyTicketMessageResponseDto);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as GetManyTicketMessageResponseDto;
    ...
    return Response<GetManyTicketMessageResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [TicketMessage] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<TicketMessage>> getOneBaseTicketMessagesControllerTicketMessage({ 
    required String id,
    BuiltList<String>? fields,
    BuiltList<String>? join,
    int? cache,
  ...
  /// Returns a [Future] containing a [Response] with a [TicketMessage] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<TicketMessage>> updateOneBaseTicketMessagesControllerTicketMessage({ 
    required String id,
    required TicketMessage ticketMessage,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,

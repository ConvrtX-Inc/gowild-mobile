...
import 'package:gowild_api/src/model/get_many_base_users_controller_user200_response.dart';
...
class UsersApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetManyBaseUsersControllerUser200Response] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GetManyBaseUsersControllerUser200Response>> getManyBaseUsersControllerUser({ 
    ...
    GetManyBaseUsersControllerUser200Response _responseData;

    try {
      const _responseType = FullType(GetManyBaseUsersControllerUser200Response);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as GetManyBaseUsersControllerUser200Response;
    ...
    return Response<GetManyBaseUsersControllerUser200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> usersControllerApproveUser({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/users/approved-user/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> usersControllerRejectUser({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/users/reject-user/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,

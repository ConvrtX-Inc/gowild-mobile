...
class UsersApi {
  ...
  Future<Response<UserEntity>> usersControllerApproveUser({ 
    ...
    final _path = r'/api/v1/users/{id}/approve'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<UserEntity>> usersControllerRejectUser({ 
    ...
    final _path = r'/api/v1/users/{id}/reject'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<UserEntity>> usersControllerUpdateAvatar({ 
    ...
    final _path = r'/api/v1/users/{id}/update-avatar'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,

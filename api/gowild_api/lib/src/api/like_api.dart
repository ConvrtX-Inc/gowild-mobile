...
class LikeApi {
  ...
  const LikeApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Like] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Like>> createOneBaseLikeControllerLike({ 
    required Like like,
    ...
    try {
      const _type = FullType(Like);
      _bodyData = _serializers.serialize(like, specifiedType: _type);
    ...
    try {
      const _responseType = FullType(Like);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> deleteOneBaseLikeControllerLike({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/like/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Like] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Like>> getOneBaseLikeControllerLike({ 
    required String id,
    BuiltList<String>? fields,
    BuiltList<String>? join,
    int? cache,
  ...
  /// Returns a [Future] containing a [Response] with a [Like] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Like>> updateOneBaseLikeControllerLike({ 
    required String id,
    required Like like,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
